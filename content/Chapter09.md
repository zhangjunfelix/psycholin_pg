+++
title = "Chapter 9 Language Development in Infancy and Early Childhood"
...
[Link to Chapter 9](/psycholin_pg/pdfs/C9.pdf)  
...
| View | Core Claim | Example |  
|------|------------|---------|  
| **Behaviorism (Skinner)** | Infants are "blank slates"—all learning post-birth via exposure/reinforcement. | Newborns prefer mother’s voice due to post-birth exposure. |  
| **Nativism (Chomsky/Pinker)** | Infants have innate language-learning mechanisms—guide pattern detection. | Newborns distinguish native language prosody (learned in utero). |  
...
|------|------------|---------|  
| **Whole-Object** | New words refer to entire objects, not parts. | *Gavagai* = whole rabbit, not ears. |  
| **Basic-Level Category** | Prefer labels like *dog* (not *poodle* or *animal*). | Hear *dog* for a poodle—learns basic level first. |  
| **Mutual Exclusivity** | No two words mean the same—new word = new object. | Shown spoon (known) + whisk (new); *fendle* = whisk. |  
...
| Stage | Age | Behavior | Example |  
|-------|-----|----------|---------|  
| 1 | 1.5–2.5 | Correct irregular use (memorized). | Says *went*, *ate*. |  
| 2 | 2.5–3.5 | Over-regularization (apply *-ed* to all). | Says *goed*, *ated*. |  
| 3 | 3.5+ | Correct regular/irregular use. | Says *walked* (regular), *went* (irregular). |  

#### Theories  
| Theory | Core Claim |  
|--------|------------|  
| **Words-and-Rules (Nativist)** | Two systems: rule-based (*-ed*) + memory (irregulars). | Over-regularization = rule use. |  
| **Connectionist** | No rules—learn patterns from input; regulars = "patterned," irregulars = "exceptional." | Computer models replicate U-curve. |  
